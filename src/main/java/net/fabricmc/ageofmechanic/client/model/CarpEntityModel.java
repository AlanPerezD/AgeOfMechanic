package net.fabricmc.ageofmechanic.client.model;
...
public class CarpEntityModel extends EntityModel<CarpEntity> {

    private final ModelPart base;

    public CarpEntityModel(ModelPart modelpart){
    ...
    @Override
    public void setAngles(CarpEntity entity , float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch){
    }
